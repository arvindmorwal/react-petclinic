This is an application that allows petclinic admin to create a visit for a pet. The UI is prefilled with Vets, and Pets information powered by backend project mentioned below.
